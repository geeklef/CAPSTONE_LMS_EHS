...
$stmt2 = $conn->prepare("SELECT answers FROM stud_exam_results WHERE exam_id = :exam_id AND stud_id = :stud_id");
$stmt2->execute(['exam_id'=>$exam_id, 'stud_id'=>$student_id]);
...
$(document).ready(function(){
    $('#closeModal').on('click', function(){
        window.location.href = '/CAPSTONE_LMS_EHS/studentdashboard/openreq/exams.php';
    });
    ...
    $('#submitExam').click(function(){
        ...
        $.post('/CAPSTONE_LMS_EHS/api/student/student_exam/submit_retake_exam.php', 
